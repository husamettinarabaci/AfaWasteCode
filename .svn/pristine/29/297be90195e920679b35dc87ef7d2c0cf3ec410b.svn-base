...
func reader(w http.ResponseWriter, req *http.Request) {
	...
	if retVal == "OK" {
		...
		retVal = saveThermRedisForStoreApi(didVal, dataVal)
...
func saveThermRedisForStoreApi(didVal string, kVal string) string {
	var retVal string = "FAIL"
	data := url.Values{
		"HASHKEY":  {"device-therm"},
		"SUBKEY":   {didVal},
		"KEYVALUE": {kVal},
	}
	client := http.Client{
