...
//CreateDb
func (res *RfidDeviceStatuType) CreateDb(currentDb *sql.DB) {
	createSQL := fmt.Sprintf(`CREATE TABLE IF NOT EXISTS ` + DATATYPE_RFID_STATU + `  (
	...
	GpsAppStatus varchar(50) NOT NULL DEFAULT '` + STATU_PASSIVE + `',
	GpsAppLastOkTime TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	GpsConnStatus varchar(50) NOT NULL DEFAULT '` + STATU_PASSIVE + `',
	GpsConnLastOkTime TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	GpsStatus varchar(50) NOT NULL DEFAULT '` + STATU_PASSIVE + `',
	...
	ContactStatus varchar(50) NOT NULL DEFAULT '` + STATU_PASSIVE + `',
