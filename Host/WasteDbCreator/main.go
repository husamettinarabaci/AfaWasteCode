...
func readerDbSet() {
	...
	createSQL = fmt.Sprintf(`CREATE TABLE IF NOT EXISTS devicedata ( 
		...
		ult_status varchar(50) NOT NULL DEFAULT '0',
		device_status varchar(50) NOT NULL DEFAULT '0',
		...
		alarm_status varchar(50) NOT NULL DEFAULT '0',
		therm_status varchar(50) NOT NULL DEFAULT '0',
		battery_status varchar(50) NOT NULL DEFAULT '0',
		battery varchar(50) NOT NULL DEFAULT '0',
		alarm_type varchar(50) NOT NULL DEFAULT '0',
