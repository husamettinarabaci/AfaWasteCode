...
var statusTypes []statusType = []statusType{
	{
		Name: WasteLibrary.RECY_APPNAME_READER,
		Key:  WasteLibrary.CHECKTYPE_APP,
		Port: "10001",
	},
	{
		Name: WasteLibrary.RECY_APPNAME_CAM,
		Key:  WasteLibrary.CHECKTYPE_APP,
		Port: "10002",
	},
	{
		Name: WasteLibrary.RECY_APPNAME_WEB,
		Key:  WasteLibrary.CHECKTYPE_APP,
		Port: "10003",
	},
	{
		Name: WasteLibrary.RECY_APPNAME_THERM,
		Key:  WasteLibrary.CHECKTYPE_APP,
		Port: "10004",
	},
	{
		Name: WasteLibrary.RECY_APPNAME_SYSTEM,
		Key:  WasteLibrary.CHECKTYPE_APP,
		Port: "10006",
	},
	{
		Name: WasteLibrary.RECY_APPNAME_TRANSFER,
		Key:  WasteLibrary.CHECKTYPE_APP,
		Port: "10000",
	},
	{
		Name: WasteLibrary.RECY_APPNAME_CHECKER,
		Key:  WasteLibrary.CHECKTYPE_APP,
		Port: "10007",
	},
	{
		Name: WasteLibrary.RECY_APPNAME_MOTOR,
		Key:  WasteLibrary.CHECKTYPE_APP,
		Port: "10008",
	},
}
...
func downloadApp(updaterType WasteLibrary.UpdaterType) WasteLibrary.ResultType {
	...
	downFile := "FIRMWARE/RECY/" + updaterType.Version + "/" + updaterType.AppType
